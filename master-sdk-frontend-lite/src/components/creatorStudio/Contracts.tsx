...
import { Contract } from '@rair-protocol/sdk/src/types/database';
...
const Contracts = () => {
  ...
  const [contractArray, setContractArray] = useState<Array<any>>([]);
  ...
  const fetchContracts = useCallback(async () => {
    const response = await rairSDK.contracts?.getFactoryList();
    if (response?.success) {
