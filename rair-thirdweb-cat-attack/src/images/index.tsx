// import Images
import astar from './astar.ico?url';
import baseMainnet from './base-logo.svg?url';
import binance from './binance-diamond.svg?url';
import blackBg from './BlackBg.webp?url';
import whiteBg from './ClayBg.webp?url';
import curios from './curios.webp?url';
import dapper from './dapper-logo.webp?url';
import newDefaultRairBG from './Default-RairTech.webp?url';
import avatar from './defaultAvatarProfile.webp?url';
import discordIconWhiteNoBorder from './discord-white-no-border.webp?url';
import documentIcon from './documentIcon.svg?url';
import ethereum from './ethereum-logo.svg?url';
import tokenLogoRair from './favicon2.png?url';
import grandpaGif from './grandpa.gif?url';
import hotdropsDefaultBanner from './hotDrops_defaultBanner.png?url';
import defaultHotDropsImg from './hotdrops-default.png?url';
import HotdropsFaviconDefault from './Hotdrops-favicon.ico?url';
import logoHotDropsLight from './HotdropsLogoLight.png?url';
import kigGif from './kid.gif?url';
import lennyGif from './lenny.gif?url';
import logoHotDrops from './logo-hotdrops.png?url';
import metamaskLogo from './metamask_logo.webp?url';
import minTable from './mintable-logo.webp?url';
import hotdropsLogoMobile from './mobile-logo-hotdrops.png?url';
import oneOf from './oneOf-logo.webp?url';
import openSea from './openSea-logo.webp?url';
// import Icons
import polygonMatic from './polygon-matic.svg?url';
import RairFaviconDefault from './rair_favicon.ico?url';
import logoBlackMobile from './RAIR-Tech-Logo-POWERED-BY-BLACK-2021.webp?url';
import logoWhiteMobile from './RAIR-Tech-Logo-POWERED-BY-WHITE-2021.webp?url';
import rairTechLogoBlue from './rairLogo_blue.webp?url';
import rairTechLogoBlack from './rairTechLogoBlack.webp?url';
import rairTechLogoWhite from './rairTechLogoWhite.webp?url';
import rarible from './rarible-logo.webp?url';
import verifiedIcon from './verify-icon.png?url';
import yotiLogo from './yoti-logo.png?url';
